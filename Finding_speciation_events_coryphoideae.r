...
cory_phylo_all_genes <- drop.tip(cory_phylo_all_genes,unpublished)
cory_phylo_all_genes <- drop.tip(cory_phylo_all_genes,root)
cory_phylo_all_genes <- drop.tip(cory_phylo_all_genes,subspANDvars)
