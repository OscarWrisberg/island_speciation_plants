...
```{r}
#Packages
packages <- c("devtools", "picante", "phytools","RColorBrewer", "geiger", "readr", "tidyverse", "ggpubr", "ggplot2","ggnewscale", "rnaturalearth", "rnaturalearthdata", "sf", "MetBrewer", "MonoPhy","ggrepel", "modelsummary", "MuMIn","MASS","pscl","png", "magick", "cowplot") #"ggtree"
...
First lets find the best possible models for our datasets
```{r}
...
Finding the best model for anagenesis
```{r}
...
finding the best models for coryphoideae
```{r}
# Finding the best model for the cladogenesis
...
Making the plot of Coryphoideae
```{r}
...
Part for plotting supplement figures and tables
```{r}
