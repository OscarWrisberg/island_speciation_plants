---
title: "Phylogenies_for_island_paper"
...
#Packages
packages <- c("devtools", "picante", "phytools","RColorBrewer", "geiger", "readr", "ggpubr", "ggplot2","ggnewscale", "rnaturalearth", "rnaturalearthdata", "sf", "MetBrewer", "MonoPhy","ggrepel", "modelsummary", "MuMIn","MASS","pscl","tidytree","cachem") # "tidyverse", "ggtree",
...
```
# This is quite good.
Now I just need to create a row in the phylogeny object which tells me if the node and branch is endemic or not.
I can probably edit the code I used for finding the endemic nodes in the analysis.

First I am gonna load the world checklist.
```{r}
#Creating a list of all accepted names within Coryphoideae
data <- read.csv(file.path("../data","checklist_names.txt"), sep = "|")
...
Now i have the most recent common ancestor nodes I can make the subtrees.
